...
The advancements in the proteomics suggest that a simplification of amino acid alphabet (by reducing the number of letters) may lead to 
...
The signalHsmm-1987 was able to very accurately predict a signal peptide, even better than predictors trained on richer data sets.
...
signalP 4.1 (no tm) \cite{2011petersensignalp} & 0.8816 & 0.8627 & 0.9005 & 0.6997 \\ 
  ...
  signalP 3.0 (NN) \cite{bendtsen_improved_2004} & 0.8938 & 0.8824 & 0.9052 & \textbf{0.7220} \\ 
   \rowcolor[gray]{0.85}signalP 3.0 (HMM) \cite{bendtsen_improved_2004} & 0.7773 & \textbf{1.0000} & 0.5545 & 0.4416 \\ 
